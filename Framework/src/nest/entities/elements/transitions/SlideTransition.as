...
//			else _scaleDownTween.nextTween = _slideOverTween;
		...
		//==================================================================================================
			...
			if( onHideComplete != null && _prevScreen ) onHideComplete( _prevScreen );
			if( onShowComplete != null ) onShowComplete( _slideOverTween.target );
		...
		//==================================================================================================
			if( onShowStart != null ) onShowStart( _slideOverTween.target );
		}
