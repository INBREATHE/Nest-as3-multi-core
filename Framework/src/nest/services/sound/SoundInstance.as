package nest.services.sound
{
	...
	public class SoundInstance {
		 ...
		 */
		public var soundCompleted:Function;
		...
		public function SoundInstance(sound:Sound = null, type:String = null, manager:SoundManager = null){
			this.sound = sound;
			this.type = type;
			...
			if(channel == this.channel){
				...
				if(_enableSeamlessLoops == false){
					...
					//Loop set number of times?
						...
						_isPlaying = false;
						soundCompleted && soundCompleted.call(this, this);
					}
				} else {
					soundCompleted && soundCompleted.call(this, this);
				}
